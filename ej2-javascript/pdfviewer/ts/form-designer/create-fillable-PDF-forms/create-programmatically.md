...
{% include code-snippet/pdfviewer/addformfield-cs3/index.ts %}
{% endhighlight %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/pdfviewer/updateformfield-cs3/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
{% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/pdfviewer/deleteformfield-cs3/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
...
![Signature Field Settings](/ej2-javascript/pdfviewer/images/SignatureField.png)
...
![Initial Field Settings](/ej2-javascript/pdfviewer/images/InitialField.png)