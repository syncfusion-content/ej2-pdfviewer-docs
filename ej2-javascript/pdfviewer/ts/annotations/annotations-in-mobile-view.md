...
![Alt text](/ej2-javascript/pdfviewer/images/edit-annotation.png)

**Step 2:** After enabling the annotation toolbar.

![Alt text](/ej2-javascript/pdfviewer/images/after-enabling-annotation-toolbar.png)

## To add sticky notes annotation

**Step 1:** click sticky notes icon and then click in the page where you want to add this.

![Alt text](/ej2-javascript/pdfviewer/images/add-sticky-notes.png)

**Step 2:** Click in the page to add the sticky notes annotation.

![Alt text](/ej2-javascript/pdfviewer/images/sticky-notes-in-page.png)
...
![Alt text](/ej2-javascript/pdfviewer/images/select-text.png)

**Step 2:** Add the text markup annotation in the PDF page

![Alt text](/ej2-javascript/pdfviewer/images/add-text-markup.png)
...
![Alt text](/ej2-javascript/pdfviewer/images/add-shapes.png)

**Step 2:** Click the shape/measure type and add annotation to the page.

![Alt text](/ej2-javascript/pdfviewer/images/open-radius.png)

**Step 3:** Add the annotation in the PDF page.

![Alt text](/ej2-javascript/pdfviewer/images/radius-annotation.png)

## To add the stamp annotation

**Step 1:** click the stamp icon and select the stamp type from the menu items.

![Alt text](/ej2-javascript/pdfviewer/images/open-stamp.png)

**Step 2:** Add the stamp annotation in the page.

![Alt text](/ej2-javascript/pdfviewer/images/add-revised.png)
...
![Alt text](/ej2-javascript/pdfviewer/images/add-signature.png)

**Step 2:** Add the signature in the page.

![Alt text](/ej2-javascript/pdfviewer/images/adding-signature.png)

## To add ink annotation

**Step 1:** Click the ink icon tool and draw in the page.

![Alt text](/ej2-javascript/pdfviewer/images/open-ink.png)

**Step 2:** Add the ink annotation in the page.

![Alt text](/ej2-javascript/pdfviewer/how-to/images/ink-annotation.png)
...
![Alt text](/ej2-javascript/pdfviewer/images/open-fillcolor.png)
...
![Alt text](/ej2-javascript/pdfviewer/images/change-property.png)
...
![Alt text](/ej2-javascript/pdfviewer/images/delete-icon.png)

## Open Comment Panel

**Step 1:** We can open the comment panel through the icon in the property tool or through the annotation toolbar.

![Alt text](/ej2-javascript/pdfviewer/images/open-comment.png)

**Step 1:** After opening the comment panel

![Alt text](/ej2-javascript/pdfviewer/images/comment-panel.png)

## Close the comment panel

**Step 1:** To close the comment panel, click the close button.

![Alt text](/ej2-javascript/pdfviewer/images/close-comment-panel.png)